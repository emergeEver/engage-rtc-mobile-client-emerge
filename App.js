...
const apiKey = 'eyJ4NXQiOiJZamd5TW1GalkyRXpNVEZtWTJNMU9HRmtaalV3TnpnMVpEVmhZVGRtTnpkaU9HUmhNR1kzWmc9PSIsImtpZCI6ImFwaV9rZXlfY2VydGlmaWNhdGVfYWxpYXMiLCJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..DIPjjA9g9FxNC79bxNP7KiIi4ZUvKw3P7Z_UbbFdQLHEJuSCSjx2fVBcQT0D8eG96FmmpnQ2-K0wOY8nlXQO4nliTs6cRhFYoIz0ZisiX7WtOtSt9kh6yqv1YvPeNDTAYTZND0FBiMhozKSQ6YxXr8O6vC6loaM_Kv3KA8HdBW4Ycz6JGnwrs5Y1eVRXQBJCQmpjtghNxsFyXPFHz99h9DD0myH3A3MfiXRjSJtz0Nb5Z8R3LSZ6SfBk21vfsE8aY2DTeudm7v0ztz7SjodfAlXdmXQBqCXiEdQfqsy1KUxdbquJaWU3t-04T-jjpnCAMX99_KRIuYVfWnZgBaMx3Q==';
...
const App = () => {
  ...
  const getRoomID = async () => {
    ...
    //try {
      const response = await fetch('https://apigateway.engagedigital.ai/api/v1/accounts/AC-5647e4c5-6bf6-4a26-9675-4a21914d6dd2/room?Status=CREATED,RESERVED&Limit=10', {
        method: 'GET',
        headers: {
...
const makeCallAndJoin = async () => {
      ...
      fetch(`https://apigateway.engagedigital.ai/api/v1/accounts/AC-5647e4c5-6bf6-4a26-9675-4a21914d6dd2/room/${roomId}/join`, {
                  method: 'POST',
                  headers: {
                    Accept: 'application/json',
                    'Content-Type': 'application/json',
